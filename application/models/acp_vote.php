...
class Acp_vote extends CI_Model
{
        ...
        function return_vote_items($id)
        {
            ...
            {
                $cont .= '<div class="menage_news"><div class="content"><div class="news_id">'.$row['id'].'</div><div class="news_title"><a href="http://wotlk.openwow.com/?item='.$row['entry'].'&xml" class="q'.$row['quality'].'">'.$row['name'].'</a></div><div class="news_options"><a class="edit" href="'.base_url('index.php/acp/vote/index/edit/'.$row['id']).'">Edit</a> - <a class="delete" href="'.base_url('index.php/acp/vote/index/delete/'.$row['id']).'">Delete</a></div><div class="clear"></div></div></div>';
            }
