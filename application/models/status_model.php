...
class Status_model extends CI_Model
{
        ...
        function show_online_players($characters_db, $start, $limit)
        {
            $this->load->database();
            ...
            $query = $this->characters->get('characters', $limit, $start);
            $cont = array();
        ...
        function count_all_online_players($characters_db, $player='')
        {
            $this->load->database();
            $config['hostname'] = $this->db->hostname;
            $config['username'] = $this->db->username;
            ...
            $this->characters = $this->load->database($config, TRUE);  
            if($player != '')
                $this->characters->where('name', $player);
