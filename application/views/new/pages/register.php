...
<div class="box_content">
	...
	<span style="float: right;">
		...
		<input type="text" name="register_username" value="" id="register_username" class="cool" onkeyup='javascript:showContent("{base_url}ajax/username_availability/" + register_username.value, "username_availability");'/>
	</span>
	...
	<span style="float: right;">
		...
		<input type="password" name="register_password" value="" id="register_password" class="cool" onkeyup='javascript:showContent("{base_url}ajax/password_availability/" + register_password.value, "password_availability") ;' />
	</span>
	<span style="clear: both; display: block;"></span>
	<span style="float: left;margin: 12px 0px 0px 0px;">
	...
	<span style="float: right;">
		...
		<input type="password" name="register_re_password" value="" id="register_re_password" class="cool" onkeyup='javascript:showContent("{base_url}ajax/password_re_availability/" + register_password.value + "/" + register_re_password.value, "password_re_availability") ;' />
	</span>
	<span style="clear: both; display: block;"></span>
	<span style="float: left;margin: 12px 0px 0px 0px;">
	...
	<span id="email_availability"></span> 
		<input type="text" name="register_email" value="" id="register_email" class="cool" onkeyup='javascript:showContent("{base_url}ajax/username_email/" + register_email.value, "email_availability") ;' />
	</span>
	<span style="clear: both; display: block;"></span>
