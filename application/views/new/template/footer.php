			...
			<div class="right_body">
					...
					{not_logged}
						<form action="{base_url}login/validation_login" method="post" accept-charset="utf-8">
							...
							<span class="left">
								...
								<label for="login_remember_me" style="cursor: pointer;">&nbsp;<strong>Remember me</strong></label>
							</span>
							<span class="right"><a href="{base_url}forget"><strong>Forgot Password?</strong></a></span><span class="clear"></span>
							{login_status}
				...
				<div class="box_content">
					{realms_status}
					<div style="background-color:#d5d5d5;border: 1px solid #BBBBBB;padding: 5px;font-weight: bold;color: #5f5f5f;margin: 5px 0px 5px 0px;text-align:center;">set realmlist {realmlist}</div>
				</div>
			</div>
			<div class="clear"></div>
		</div>
