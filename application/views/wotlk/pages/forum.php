			...
			{threads}
				<tr class="thread">
					<td class="td" width="500px">
						...
						<br />
						<span class="forum_description"><a href="{thread_poster_link}" style="color: #333333;">{thread_poster}</a></span>
					</td>
					<td class="td">
						{thread_last_post}
	...
	{show_posts}
		<table class="post_content">
			...
			{posts}
				...
				<tr>
					<td width="200px" align="center" bgcolor="#D0D0D0" class="td" valign="top">
		...
		{is_allowed_post}
			...
			<table class="post_content">
					...
					<form action="{base_url}index.php/forum/validation_post" method="post" accept-charset="utf-8">
						...
						<tr>
							<td colspan="2" align="center"><div class="post_container"><label for="forum_post">Message:</label><br /><textarea class="cool_textfield post_input" id="forum_post" name="forum_post" placeholder="Write your reply..."/></textarea>{status}</div></td>
						</tr>
						<tr>
		...
		<div class="clear"></div><br />
			<table class="post_content">
					...
					<form action="{base_url}index.php/forum/validation_edit_post" method="post" accept-charset="utf-8">
						...
						<tr>
							<td colspan="2" align="center"><div class="post_container"><label for="forum_post">Message:</label><br /><textarea class="cool_textfield post_input" name="forum_post" id="forum_post" placeholder="Write your reply..."/>{post}</textarea>{status}</div></td>
						</tr>
						<tr>
							<td colspan="2" align="center"><input type="submit" value="Edit Reply" class="cool_button" /></td>
						</tr>
					</form>
			</table>
			<div class="clear"></div>
				...
				<tr>
					<td colspan="2" align="center">
						<div class="post_container">
							...
							<span class="right"><input type="text" name="name" id="name" placeholder="Thread Name..." class="cool_textfield" style="width: 210px" /></span><span class="clear"></span>
							<span class="left" style="margin-top: 10px;"><label for="description">Description:</label></span>
							<span class="right"><input type="text" name="description" id="description" placeholder="Thread Description..." class="cool_textfield" style="width: 210px" /></span><span class="clear"></span>
						</div>
					</td>
				</tr>
				<tr>
					<td colspan="2" align="center"><div class="post_container"><label for="forum_post">Message:</label><br /><textarea class="cool_textfield post_input" name="forum_post" id="forum_post" placeholder="Write your reply..."/></textarea>{status}</div></td>
				</tr>
				<tr>
					<td colspan="2" align="center"><input type="submit" value="Post New Thread" class="cool_button" /></td>
				</tr>
			</form>
		</table>
		<div class="clear"></div>
							...
							<td colspan="2" align="center">
								<div class="post_container">
									...
									<span class="left" style="margin-top: 10px;">Forum:</span><span class="right">
										<?php echo form_dropdown('forum', $all_forums, $thread[0]['forum'],'class="cool_textfield" style="width: 300px;"'); ?>
									</span><span class="clear"></span>
									<span class="left" style="margin-top: 10px;">Locked:</span><span class="right">
										<?php $locked_types = array(0 => 'Not Locked', 1 => 'Locked'); echo ($this->auto->is_admin) ? form_dropdown('locked', $locked_types, $thread[0]['locked'],'class="cool_textfield" style="width: 300px;"') : ''; ?>
									</span><span class="clear"></span>
									{status}
								</div>
							</td>
