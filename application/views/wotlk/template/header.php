...
<head>
	...
	{header_content}
	<link type="text/css" rel="stylesheet" href="{base_url}application/views/wotlk/css/style.css" />
	<link type="text/css" rel="stylesheet" href="{base_url}application/views/wotlk/css/skitter.css" />
	<script type="text/javascript" src="{base_url}application/views/wotlk/js/menu.js"></script>
	<script type="text/javascript" src="{base_url}application/views/wotlk/js/script.js"></script>
</head>
<body>
	<div class="wrapper" id="wrapper">
		...
		<center>
		<div class="container">
			<a href="{base_url}"><div class="logo">Cheer - World</div></a><div class="clear"></div>
			{not_logged}
